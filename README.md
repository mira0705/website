...
<head>
    ...
    <title>Абай Университеті | МФИ Факультеті</title>
    ...
    <style>
        ...
        * {
        ...
        body {
            background: linear-gradient(rgba(90, 98, 104, 0.92), rgba(90, 98, 104, 0.92)), 
                        url('https://abaiuniversity.edu.kz/wp-content/uploads/2023/01/main-building.jpg') no-repeat center/cover fixed;
            color: #f0f0f0;
            line-height: 1.7;
            min-height: 100vh;
            display: flex;
    ...
    <main>
        ...
        <section id="science">
            ...
            <div class="department-card">
                ...
                <p><strong>Монографиялар:</strong> 8 монография, оның ішінде 3-і халықаралық баспаларда жарияланды</p>
            </div>
        </section>
        ...
        function animateStats() {
            ...
            statNumbers.forEach(stat => {
                ...
                function updateNumber(currentTime) {
                    ...
                    stat.innerText = value === target ? target + (stat.innerText.includes('+') ? '+' : '') : value;
